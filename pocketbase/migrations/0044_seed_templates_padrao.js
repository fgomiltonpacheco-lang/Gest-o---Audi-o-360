...
migrate(
  (app) => {
    ...
    const audiometriaLayout = [
      ...
      // Cabeçalho clínica (nome, endereço, telefone)
      {
        id: 'cabecalho',
        type: 'text',
      ...
      // Título AUDIOMETRIA TONAL E VOCAL
      {
        id: 'titulo',
        type: 'text',
        label: 'Título',
        ...
        props: { content: 'AUDIOMETRIA TONAL E VOCAL', contentType: 'static' },
      },
      // Identificação do paciente (tabela dinâmica)
      {
        id: 'identificacao',
        type: 'table',
      ...
      // Audiograma gráfico
      {
        ...
        height: 70,
        zIndex: 2,
        props: { mode: 'combined', showAir: true, showBone: true },
      },
      // Médias tonais
      {
        id: 'medias_tonais',
        ...
        height: 16,
        zIndex: 2,
        props: { dynamicSource: 'medias_tonais', fontSize: 8 },
      },
      // SRT/LDV
      {
        id: 'srt_ldv',
        ...
        height: 14,
        zIndex: 2,
        props: { dynamicSource: 'srt_ldv', fontSize: 8 },
      },
      // IPRF
      {
        id: 'iprf',
      ...
      // Referências bibliográficas
      {
        ...
        height: 8,
        zIndex: 2,
        style: { fontSize: 6, italic: true, color: '#64748b', align: 'justify' },
        props: {
          content:
      ...
      // Assinatura do profissional
      {
        ...
        height: 16,
        zIndex: 2,
        props: { who: 'profissional', showName: true, showCrfa: true, lineWidth: 60 },
      },
      // Rodapé
      {
        id: 'rodape',
