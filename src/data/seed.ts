...
export const SEED_PATIENTS: Patient[] = [
  ...
  {
    id: 'pat-15s',
    name: 'Joana Aparecida Nogueira',
    cpf: '667.788.990-01',
    birthDate: '1965-04-12',
    gender: 'Feminino',
    phone: '(11) 2544-7788',
    mobile: '(11) 98901-4567',
    email: 'joana.nogueira@email.com.br',
    cep: '02401-000',
    street: 'Avenida Casa Verde',
    number: '1100',
    ...
    previousHearingAid: false,
    generalNotes:
      'Paciente encaminhada pelo SUS para avaliação audiológica. Relata dificuldade progressiva de audição há cerca de 3 anos.',
    status: 'Ativo',
...
export const SEED_APPOINTMENTS: Appointment[] = [
  {
    ...
    time: '08:30',
    duration: 60,
    professionalName: 'Milton Soares Pacheco',
    status: 'Confirmado',
    ...
    movements: [
      {
        ...
        type: 'Entrada',
        quantity: 50,
        responsible: 'Milton Soares Pacheco',
