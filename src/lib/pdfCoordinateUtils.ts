...
export const DEFAULT_AUDIOMETRIA: AudiometriaCoordinates = {
  ...
  lrfOE: { x: 422, y: 460 },
  ldvOE: { x: 500, y: 460 },
  iprfOD: { intensidadeX: 98, dissilabosX: 160, monossilabosX: 225, mascaramentoX: 258, y: 408 },
  iprfOE: { intensidadeX: 98, dissilabosX: 160, monossilabosX: 225, mascaramentoX: 258, y: 392 },
  parecer: { x: 45, y: 195 },
...
export function mergeAudiometria(saved?: Record<string, unknown> | null): AudiometriaCoordinates {
  ...
  return {
    ...
    logo: mergeBox(d.logo ?? { left: 45, top: 805, width: 120, height: 42 }, s.logo),
  }
}
